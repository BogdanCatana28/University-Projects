...
def signUpPage():
    return pc.center(
        pc.vstack(
            pc.heading("Choose a username and a password for your account:", font_size="3em",
            ...
            pc.vstack(
                ...
                pc.input(placeholder="Password", on_blur=AuthState.AuthState.set_password, bg="white"),
                pc.input(placeholder="Confirm Password", on_blur=AuthState.AuthState.set_confirm_password, bg="white"),
                pc.input(placeholder="Birthday date", on_blur=AuthState.AuthState.set_birthday, bg="white"),
                pc.button(
                    "Sign Up",
                    variant="outline",
                    border_radius="1em",
                    on_click=AuthState.AuthState.signup,
                    bg="white",
                ),
                padding="2em",
                shadow="lg",
